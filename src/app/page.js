...
const PROJECTS = [
  ...
  },
  {
    ...
    type: 'Personal Launch · AI Chatbot',
    outcome: 'AI chatbot assistant integrated into business websites to automate customer interactions and reduce manual workload.',
  ...
  {
    name: 'Navly',
    type: 'Personal Launch · Immigration Tracker',
    outcome: 'Immigration tracking app that helps users monitor their application status, deadlines, and document requirements in one place.',
    stack: ['React', 'Next.js', 'Node.js'],
    challenge: 'Make a complex, stressful process — immigration — feel structured and manageable for users who may not speak the language fluently.',
    decision: 'Built a clear dashboard-style tracker with status timelines and deadline alerts, keeping the UI simple and the data easy to act on.',
    link: '/projects',
    linkLabel: 'View project',
  },
];
